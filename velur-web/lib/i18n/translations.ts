...
const en = {
  ...
  hero: {
    pill: "Early access · 40+ DTC brands live on Velur",
  ...
  receipts: {
    sectionLeft: "03 / THE PLATFORM",
    sectionRight: "IN NUMBERS",
    stats: [
      { label: "Years of DTC and subscription revenue intelligence", caption: "Across teams at brands you've heard of" },
      { label: "In combined revenue tracked through the Velur platform", caption: "Apparel, consumables, marketplace, subscription" },
      { label: "Average time from connecting your stack to your first revenue intelligence report", caption: "No data engineering team required" },
    ],
  },
  cta: {
    default:     { h1: "Ready to see your revenue in a new light?",           h2: "Book a demo.",              meta: "15 minutes · See the platform live · Your data connected in 48h", btn: "Book a demo →" },
    platform:    { h1: "Ready to see your revenue intelligence layer?",       h2: "Book a demo.",              meta: "15 minutes · See the platform live · Your data connected in 48h", btn: "Book a demo →" },
    company:     { h1: "Want to know if Velur is right for your brand?",      h2: "Book a demo and find out.", meta: "15 minutes · See the platform live · No pitch", btn: "Book a demo →" },
    caseStudies: { h1: "Your numbers already tell the story.",                h2: "Let's read them together.", meta: "15 minutes · See the platform live · Your data connected in 48h", btn: "Book a demo →" },
  },
  services: {
  ...
  contact: {
    ...
    h1a: "See your revenue",
    h1b: "intelligence live.",
    subhead: "15 minutes. We connect to your Shopify and Klaviyo, walk through what Velur surfaces, and you decide if it's right for your brand. No deck. No pitch.",
    whatToExpect: "WHAT TO EXPECT",
    timeline: [
      { time: "0:00", text: "Quick intro — what your business does and where you are today" },
      { time: "0:05", text: "Live walkthrough of the Velur platform with your data" },
      { time: "0:10", text: "Which modules — Pulse, Attribution, Cohorts — make the most sense for you" },
      { time: "0:25", text: "Q&A — anything you want to ask, no pressure" },
    ],
    noTime: "Don't have time for a call? Email",
    async: "We work async with clients across timezones.",
    response: "We respond within 24 hours, weekdays.",
    iframeTitle: "Book a demo with Velur",
  },
  faq: {
    ...
    stillHaveQuestionsBody: "15 minutes is all it takes. We'll show you the platform live with your own data.",
    contactBtn: "Book a demo →",
    categories: [
      {
        title: "The Platform",
        items: [
...
const es: typeof en = {
  ...
  hero: {
    pill: "Acceso anticipado · Más de 40 marcas DTC activas en Velur",
  ...
  receipts: {
    sectionLeft: "03 / LA PLATAFORMA",
    sectionRight: "EN CIFRAS",
    stats: [
      { label: "Años de inteligencia de ingresos DTC y suscripciones", caption: "En equipos de marcas que conoces" },
      { label: "En ingresos combinados rastreados por la plataforma Velur", caption: "Moda, gran consumo, marketplace, suscripción" },
      { label: "Tiempo medio desde conectar tu stack hasta tu primer informe de inteligencia", caption: "Sin necesidad de equipo de ingeniería de datos" },
    ],
  },
  cta: {
    default:     { h1: "¿Listo para ver tus ingresos bajo una nueva luz?",              h2: "Reserva una demo.",             meta: "15 minutos · Ve la plataforma en directo · Tus datos conectados en 48h", btn: "Reservar demo →" },
    platform:    { h1: "¿Listo para ver tu capa de inteligencia de ingresos?",         h2: "Reserva una demo.",             meta: "15 minutos · Ve la plataforma en directo · Tus datos conectados en 48h", btn: "Reservar demo →" },
    company:     { h1: "¿Quieres saber si Velur es la solución para tu marca?",        h2: "Reserva una demo y descúbrelo.", meta: "15 minutos · Ve la plataforma en directo · Sin pitch de ventas", btn: "Reservar demo →" },
    caseStudies: { h1: "Tus números ya cuentan la historia.",                           h2: "Leámoslos juntos.",              meta: "15 minutos · Ve la plataforma en directo · Tus datos conectados en 48h", btn: "Reservar demo →" },
  },
  services: {
  ...
  contact: {
    ...
    h1a: "Ve tu inteligencia de",
    h1b: "ingresos en directo.",
    subhead: "15 minutos. Conectamos tu Shopify y Klaviyo, recorremos lo que muestra Velur y tú decides si es la solución correcta para tu marca. Sin presentación. Sin pitch de ventas.",
    whatToExpect: "QUÉ ESPERAR",
    timeline: [
      { time: "0:00", text: "Presentación rápida — qué hace tu negocio y dónde estás ahora" },
      { time: "0:05", text: "Recorrido en directo de la plataforma Velur con tus datos" },
      { time: "0:10", text: "Qué módulos — Pulso, Atribución, Cohortes — tienen más sentido para ti" },
      { time: "0:25", text: "Preguntas y respuestas — todo lo que quieras preguntar, sin presión" },
    ],
    noTime: "¿No tienes tiempo para una llamada? Escríbenos a",
    async: "Trabajamos de forma asíncrona con clientes en diferentes zonas horarias.",
    response: "Respondemos en 24 horas, días laborables.",
    iframeTitle: "Reservar demo con Velur",
  },
  faq: {
    ...
    stillHaveQuestionsBody: "15 minutos son suficientes. Te mostramos la plataforma en directo con tus propios datos.",
    contactBtn: "Reservar demo →",
    categories: [
      {
        title: "La Plataforma",
        items: [
