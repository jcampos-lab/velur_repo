...
const en = {
  ...
  benchmarkGrid: {
    ...
    supportStats: [
      { num: "42%", label: "Of mid-market DTC brands", body: "cannot accurately attribute revenue post-iOS14, leading to significant misdirected ad spend across channels." },
      { num: "2.5×", label: "Revenue growth advantage", body: "for data-native brands that invest in first-party analytics infrastructure vs. those who don't." },
    ],
  },
  threeThings: {
    sectionLeft: "02 / THE GUARANTEE",
    sectionRight: "WHAT YOU CAN COUNT ON",
    heading1: "Three things we",
    ...
    categories: [
      {
        ...
        items: [
          ...
          },
          {
            ...
            a: "Every morning, Velur generates a briefing that surfaces your key metrics, net revenue, MRR, blended ROAS, contribution margin, alongside a plain-English note explaining the movements. If your revenue dropped 12% yesterday, Velur points to what's behind it, for example a drop in Meta conversion rate alongside a delivery delay showing in Shopify. It shows correlations and leaves causation to your judgement, with the numbers behind each one.",
          },
          {
...
const es: typeof en = {
  ...
  benchmarkGrid: {
    ...
    supportStats: [
      { num: "42%", label: "De las marcas DTC medianas", body: "no pueden atribuir ingresos con precisión tras iOS14, lo que genera un gasto publicitario significativo en canales equivocados." },
      { num: "2.5×", label: "Ventaja de crecimiento", body: "para las marcas data-native que invierten en analítica propia frente a las que no lo hacen." },
    ],
  },
  threeThings: {
    sectionLeft: "02 / LA GARANTÍA",
    sectionRight: "EN LO QUE PUEDES CONTAR",
    heading1: "Tres cosas que",
        ...
        items: [
          {
            ...
            a: "Velur es una capa de inteligencia de ingresos, algo distinto a un dashboard. Un dashboard te muestra números. Velur te muestra qué cambió, lo que hay detrás y qué revisar a continuación, con cada cifra trazable hasta su fuente. Cada métrica incluye una nota en lenguaje claro. Es apoyo a la decisión, no un sustituto de tu criterio ni de tu analista.",
          },
          {
