...
const COPY = {
  en: {
    ...
    p2Pre: "I'm also building the data and creative infrastructure behind ",
    p2Mid: ", a spa in Port St. Lucie — our first client, and a live proof of concept for everything Velur does.",
  ...
  es: {
    ...
    p2Pre: "También estoy construyendo la infraestructura de datos y creativa detrás de ",
    p2Mid: ", un spa en Port St. Lucie — nuestro primer cliente, y una prueba de concepto en vivo de todo lo que Velur hace.",
