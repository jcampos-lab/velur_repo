    ...
    <section className="bg-cream py-14 md:py-20 border-y border-line">
      <div className="max-w-[1440px] mx-auto px-6 md:px-12">
        ...
        <div className="mb-10 md:mb-12 max-w-2xl">
          ...
          >
            Hi, I&apos;m Alexander.
            <span className="text-ink/55"> I built Velur for founders like you.</span>
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start">
          ...
          >
            <div className="space-y-5 max-w-2xl">
              ...
              <p className="font-sans text-base md:text-lg text-ink/80 leading-relaxed">
                I&apos;m also the person building <Link href="https://camilab.studio" target="_blank" rel="noopener noreferrer" className="text-amber hover:underline underline-offset-4">Cami Lab Studio</Link>, a spa in Port St. Lucie, using the same playbook Velur runs on, plus Higgsfield and MidJourney for the creative side. It is a live test of what good analytics and good AI tooling can do for a small business, run by one person.
              </p>
              <p className="font-sans text-base md:text-lg text-ink/80 leading-relaxed">
                I&apos;m not here to upsell you on another dashboard. I&apos;m here to help you understand your numbers and put AI to work where it actually pays for itself. If that sounds useful, let&apos;s talk.
              </p>
            </div>
