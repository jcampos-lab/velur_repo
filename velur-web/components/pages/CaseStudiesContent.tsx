    ...
    <>
        ...
        <div className="max-w-[1440px] mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-5 flex flex-col gap-6">
              <h1
                className="font-display font-normal text-ink leading-[0.95] tracking-[-0.04em]"
        ...
        <div className="max-w-[1440px] mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            ...
            <div className="lg:col-span-8 flex flex-col gap-6">
              <h2
                className="font-display font-normal text-ink leading-tight tracking-[-0.03em]"
      ...
      <section className="bg-paper py-24">
        <div className="max-w-[1440px] mx-auto px-6 md:px-12">
          ...
          <div className="card-group grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {rest.map((r, i) => (
              <div
                key={i}
              ...
              >
                ...
                <div className="flex flex-col gap-3 flex-1">
                  <h3 className="font-display font-normal text-ink text-lg leading-snug">{r.headline}</h3>
        ...
        <div className="max-w-[1440px] mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            <div className="lg:col-span-6">
              <h2
                className="font-display font-normal text-ink leading-tight tracking-[-0.04em]"
