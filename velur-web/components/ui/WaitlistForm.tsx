  ...
  return (
    <form onSubmit={handleSubmit} className="border border-line bg-paper rounded-2xl p-8 md:p-10 flex flex-col gap-6">
      ...
      <button
        type="submit"
        disabled={state === "loading"}
        className="inline-flex items-center justify-center gap-2 bg-ink text-paper font-sans font-medium text-base px-6 py-4 rounded-lg hover:bg-amber hover:text-paper transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
      >
