    ...
    <>
      ...
      <section className="bg-cream py-14 md:py-20">
        <div className="max-w-[720px] mx-auto px-6 md:px-12">
          ...
          <Link
            href="/contact"
            className="inline-flex items-center gap-2 font-sans font-medium text-sm bg-ink text-paper px-6 py-3 rounded-full hover:bg-amber hover:text-ink transition-colors duration-200"
          >
            Book a demo →
          </Link>
        </div>
