    ...
    <>
      ...
      <section className="bg-paper pt-16 md:pt-20 pb-12 md:pb-14 border-b border-line">
        <div className="max-w-[1440px] mx-auto px-6 md:px-12">
          ...
          <div className="max-w-[720px]">
            ...
            <h1
              className="font-display font-normal text-ink leading-[1.1] tracking-[-0.025em] mb-5"
      ...
      <section className="bg-cream py-14 md:py-20">
        <div className="max-w-[720px] mx-auto px-6 md:px-12">
          ...
          <Link
            href="/contact"
            className="inline-flex items-center gap-2 font-sans font-medium text-sm bg-ink text-paper px-6 py-3 rounded-lg hover:bg-amber hover:text-paper transition-colors duration-200"
          >
            Join the waitlist →
          </Link>
        </div>
