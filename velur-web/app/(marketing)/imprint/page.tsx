    ...
    <section className="bg-paper pt-16 md:pt-20 pb-20 md:pb-24">
      <div className="max-w-[720px] mx-auto px-6 md:px-12">
        ...
        <div className="space-y-8 font-sans text-base text-ink leading-relaxed">
          <div>
            <h2 className="font-display font-normal text-xl mb-3">Responsible for this website</h2>
          ...
          <div>
            <h2 className="font-display font-normal text-xl mb-3">Dispute resolution</h2>
            <p>
          ...
          <div>
            <h2 className="font-display font-normal text-xl mb-3">Content liability</h2>
            <p>
